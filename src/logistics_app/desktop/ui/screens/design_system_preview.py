"""ASCII-only preview window for the reusable desktop design system."""
...
class DesignSystemPreviewWindow(QMainWindow):
    """Preview window for the shared enterprise desktop design system."""
    ...
    def __init__(self) -> None:
        ...
        cards_layout.addWidget(
            SummaryCard(
                "Deliveries Ready",
                "18",
                "Awaiting document print and final load confirmation",
                "Stable",
                "success",
            ),
            0,
        ...
        cards_layout.addWidget(
            SummaryCard(
                "Pallet Exceptions",
                "3",
                "Require location or document correction before release",
                "Attention",
                "warning",
            ),
            0,
        ...
        cards_layout.addWidget(
            SummaryCard(
                "Print Queue",
                "7",
                "Warehouse workstations currently processing outbound jobs",
                "Active",
                "info",
            ),
            0,
